export enum ComponentName {
  ...
  HERO = `hero`,
  SHOWCASE_GRID_WITH_FOUR_COLUMNS = `showcase-with-four-columns`,
  SHOWCASE_GRID_WITH_THREE_COLUMNS = `showcase-with-three-columns`,
  SHOWCASE_GRID_WITH_MARKDOWN_COLUMN = `showcase-with-markdown-column`,
